...
import 'package:food_delivery/view/explore/explore_detail_view.dart';
import 'package:food_delivery/view/explore/search_view.dart';
              ...
              children: [
                ...
                Expanded(
                  child: GridView.builder(
                    ...
                    gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, childAspectRatio: 0.95, crossAxisSpacing: 15, mainAxisSpacing: 15), 
                    itemCount: findProductArr.length,
                    itemBuilder: ((context, index) {
                    var eObj = findProductArr[index] as Map? ?? {};
                    return ExploreCell(pObj: eObj,onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => ExploreDetailView(eObj: eObj)));
                    },);
                  })),
                )
