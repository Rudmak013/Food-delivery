...
import 'package:food_delivery/common_widget/dropdown.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Select Your Location", style: TextStyle(
                      ...
                      Dropdown(title: "Your Area", placeholder: "Types of Area", valueList: const ["Area 1","Area 2"], didChange: (sObj){
